<h2><a href="https://www.geeksforgeeks.org/problems/count-primes-in-range1604/1?page=1&category=sieve&sortBy=submissions">Count Primes In Range</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two numbers L and R(L&lt;R). Count all the prime numbers in the range [L, R].</span></p>
